...
- [PASS] Ledger has launch, completion/block, and teardown events. ev: `python3 <private-workspace>/orchestrator/ledger.py show boxed-masked-rerun` shows `launched`, `running`, `driver-done`, `torndown`.
