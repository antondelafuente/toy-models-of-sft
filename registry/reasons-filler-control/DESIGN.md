...
**Designer-of-record:** claude-2 · **Cleared by Anton:** filler-design decision = "Both (airtight)" 2026-06-30 (two filler arms: form-matched + content-free). · **Status:** pre-registration, gates pending.
...
## Filler-string design (LOAD-BEARING — strings LOCKED here; data-audit verifies; Anton arbitrates)
