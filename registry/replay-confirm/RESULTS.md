...
- Follow-ups (not queued): replay-dose curve (10/23/50%); clip+replay stack; Pareto viz update (3-seed solid marker — awaiting the author's call on the hollow-marker proposal).
