...
Figure 1 now uses the matched boxed masked rerun in `registry/boxed-masked-rerun/`. This closes the plotted-value gap and adds coauthor's requested masked-answer control. The Hugging Face data and adapter repos now carry the curated public release artifacts.
