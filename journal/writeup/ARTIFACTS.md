...
| 14. coauthor washout checks | `figures/figure_appendix_washout_coauthor_asks.svg` | `plot_data/figure14_appendix_washout_coauthor_asks.json` | `scripts/generate_paper_figures.py` | Good as an appendix diagnostic. Traces to `registry/washout-curve/RESULTS.md`, `assemble_curves.py`, and the June 18 visualization data. |
