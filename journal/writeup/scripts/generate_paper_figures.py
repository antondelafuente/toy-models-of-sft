#!/usr/bin/env python3
"""Generate editable SVG figures for the lab writeup.
...
def render_figure_appendix_washout_coauthor_asks() -> str:
    width, height = 1180, 920
    plot_data = load_plot_data("figure14_appendix_washout_coauthor_asks.json")
    ...
    body = [
        *title_lines(54, 44, ["Does it wash away? What protects the trait"], size=24, gap=29),
        text(54, 82, "Four controlled coauthor-ask comparisons. Misbehavior / AM only; lower is safer. Lighter is baseline, darker is the condition.", size=13, fill="#64748b"),
    ]
    ...
    return svg(width, height, body, label="Four coauthor washout pair comparisons")
...
FIGURES = {
    ...
    "figure_appendix_washout_coauthor_asks": render_figure_appendix_washout_coauthor_asks,
}
