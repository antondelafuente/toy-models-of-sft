...
// coauthor's asks — AM only (capability/GPQA always recovers under wash, so it isn't the question).
...
export function WashoutCurve20260618() {
  ...
  // one pair (2 lines), AM only — self-contained; two of these sit side by side per row of coauthor's panel.
    ...
    <div className="space-y-10">
      ...
      <section className="space-y-6">
        <div className="text-center">
          <div className="text-[11px] uppercase tracking-[0.18em] text-muted-foreground">coauthor's asks</div>
