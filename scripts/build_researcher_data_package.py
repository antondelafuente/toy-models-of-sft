...
INCLUDES: list[tuple[str, str, str, str]] = [
    ...
    ("repo", "registry/reasons-filler-control/RESULTS.md", "provenance/toy/reasons-filler-control/RESULTS.md", "neutral filler control results"),
    ("repo", "registry/reasons-filler-control/DESIGN.md", "provenance/toy/reasons-filler-control/DESIGN.md", "neutral filler control design"),
    ("repo", "registry/reasons-filler-control/DATA_AUDIT.md", "provenance/toy/reasons-filler-control/DATA_AUDIT.md", "neutral filler control data audit"),
    ("repo", "registry/reasons-filler-control/analysis/results", "eval_outputs/toy/reasons-filler-control", "neutral filler aggregate result tables"),
